>>define wait immediately layer value part before after
inside outside definition property rule method pack allowance call operator problem expect search signify receive failure
...
- [appreciation]()
 ...
 ### property attribute characteristic feature affinity order quality apanage thing kin connection connexion peculiarity
...
- [algorithm]()
 ...
 ### method way mode process how algorithm
- [method]()
...
- [algorithm]()
 ...
 ### pack variety mass stack legion oodles bags ruck bags army power wilderness score cloud regiment pile
- [plurality]()
...
### expect await anticipate think fear apprehend
- [expect]()
    - ожидать, рассчитывать, ждать, надеяться, предполагать, полагать
- [await]()
    - ждать, ожидать, предстоять
- [anticipate]()
    - предвидеть, ожидать, предвосхищать, опережать, предупреждать, предчувствовать
- [look forward]()
    - смотреть в будущее, ожидать
- [look for]()
    - искать, надеяться на, ожидать
- [be waiting]()
    - ожидать, дожидаться
- [think]()
    - думать, мыслить, считать, полагать, размышлять, ожидать
- [contemplate]()
    - созерцать, лицезреть, размышлять, рассматривать, обдумывать, ожидать
- [fear]()
    - бояться, опасаться, страшиться, ожидать
- [apprehend]()
    - задерживать, понимать, опасаться, постигать, предчувствовать, ожидать
- [bargain for]()
    - ожидать, быть готовым к

### search seek quest pick grope rummage ransack fossick
- [search]()
    - искать, поискать, обыскивать, разыскивать, исследовать, зондировать
- [seek]()
    - искать, добиваться, стремиться, просить, обращаться, пытаться
- [look for]()
    - искать, надеяться на, ожидать
- [seek out]()
    - искать, разыскивать, отыскивать
- [look up]()
    - искать, смотреть вверх, поднимать глаза, улучшаться, повышаться, навещать
- [hunt for]()
    - искать, добиваться, гоняться за чем-л.
- [quest]()
    - искать, производить сбор подаяний, производить поиски, разыскивать
- [pick]()
    - выбирать, собирать, подбирать, ковырять, отбирать, искать
- [go after]()
    - идти за, преследовать, искать, добиваться
- [dig for]()
    - искать
- [grope]()
    - нащупывать, искать, ощупывать, искать ощупью, идти ощупью
- [rummage]()
    - рыться, копаться, перерыть, вылавливать, вытаскивать, искать
- [ransack]()
    - грабить, обыскивать, искать, обчищать, рыться в поисках потерянного
- [hunt after]()
    - искать, рыскать, гоняться
- [root out]()
    - выискивать, вырывать с корнем, искать, рыться, уничтожать
- [fossick]()
    - шарить, искать
- [ferret about]()
    - разыскивать, искать
- [root up]()
    - корчевать, вырывать с корнем, искать, рыться, уничтожать, выискивать
- [rummage about]()
    - копаться, рыться, искать
- [rummage in]()
    - рыться, копаться, искать
 
 ### signify denote mark note define tab
- [signify]()
    - обозначать
- [denote]()
    - обозначать, означать, указывать, отмечать, указывать на, выражать
- [designate]()
    - обозначать, определять, указывать, называть, устанавливать, характеризовать
- [denominate]()
    - называть, обозначать
- [mark]()
    - отмечать, маркировать, обозначать, помечать, размечать, метить
- [note]()
    - отмечать, делать заметки, записывать, указывать, обращать внимание, обозначать
- [define]()
    - определять, устанавливать, обозначать, очерчивать, устанавливать значение, устанавливать границы
- [mark in]()
    - обозначать
- [tab]()
    - обозначать, сводить в таблицы, называть
 
 ### receive get have make receive obtain find gain take acquire derive collect draw pull win touch
- [receive]()
    - получать
- [get]()
    - получать, попасть, становиться, добираться, иметь, сесть
- [have]()
    - иметь, обладать, получать, содержать, испытывать, проводить
- [make]()
    - делать, совершать, производить, создавать, зарабатывать, получать
- [receive]()
    - получать, принимать, воспринимать, вмещать, выслуживать, признавать правильным
- [obtain]()
    - получать, приобретать, добиваться, достигать, добывать, применяться
- [find]()
    - находить, обрести, изыскать, разыскать, считать, получать
- [gain]()
    - получать, набирать, приобретать, зарабатывать, выигрывать, добиваться
- [take]()
    - принимать, брать, считать, занимать, использовать, получать
- [acquire]()
    - приобретать, получать, овладевать, обзаводиться, наживать, заводить
- [derive]()
    - получать, извлекать, выводить, происходить, наследовать, производить
- [collect]()
    - собирать, взимать, получать, собираться, коллекционировать, инкассировать
- [draw]()
    - рисовать, привлекать, проводить, черпать, начертить, получать
- [pull]()
    - тянуть, вытащить, потянуть, дергать, вытаскивать, получать
- [fetch]()
    - получать, выбирать, привести, приносить, доставать, вызывать
- [secure]()
    - обезопасить, гарантировать, добиваться, закреплять, получать, обеспечивать безопасность
- [win]()
    - выигрывать, побеждать, добиваться, заработать, одерживать, получать
- [come by]()
    - проходить мимо, заходить, получать, приобретать, доставать, унаследовать
- [contract]()
    - сокращаться, сжиматься, сужаться, заключать договор, сокращать, получать
- [come in for]()
    - получать
- [touch]()
    - коснуться, касаться, трогать, тронуть, прикасаться, получать

### failure fail collapse failing flop fiasco washout laydown rot defection reverse plow frost
- [failure]()
    - недостаточность, отказ, провал, неудача, сбой, неспособность
- [fail]()
    - провал, неудача, облом, неудача на экзамене
- [collapse]()
    - крах, коллапс, обвал, крушение, падение, провал
- [failing]()
    - недостаток, неудача, провал, слабость, ошибка, слабохарактерность
- [flop]()
    - провал, неудача, неудачник, шлепанье, ночлежка, жульничество
- [fizzle]()
    - фиаско, провал, неудача, шипящий звук
- [fiasco]()
    - фиаско, провал, облом, неудача
- [washout]()
    - смыв, размыв, провал, промывание, неудачник, смывание
- [sink]()
    - раковина, слив, сток, клоака, сточная труба, провал
- [laydown]()
    - провал
- [suck]()
    - всасывание, сосание, глоток, провал, засасывание, небольшой глоток
- [rot]()
    - гниль, гниение, вздор, труха, полоса неудач, провал
- [defection]()
    - отступничество, дезертирство, ренегатство, неудача, нарушение, провал
- [reverse]()
    - противоположное, задний ход, реверсирование, обратная сторона, превратность, провал
- [plow]()
    - плуг, пашня, снегоочиститель, провал, токосниматель, вспаханное поле
- [plough]()
    - плуг, пашня, снегоочиститель, провал, токосниматель, вспаханное поле
- [turkey]()
    - индейка, индюк, индюшка, провал, неудача
- [vampire]()
    - вампир, упырь, вурдалак, кровопийца, провал, вымогатель
- [pluck]()
    - смелость, ливер, мужество, потроха, отвага, провал
- [fluke]()
    - счастливая случайность, трематода, камбала, палтус, зазубрина гарпуна, провал
- [frost]()
    - мороз, иней, фиаско, холодность, неудача, провал
- [flivver]()
    - дешевый автомобиль, неудача, тачка, провал, дешевый самолет, что-либо незначительное
- [burst-up]()
    - провал, крах